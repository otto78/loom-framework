...
> When a user says "read Antigravity", "leggi Antigravity", "setup Antigravity" or similar, follow these instructions.

> **IT — IMPORTANTE:** Questo file è letto dagli agenti AI per capire come configurare il framework.  
> Quando l'utente dice "leggi Antigravity", "read Antigravity", "configura Antigravity" o simili, segui queste istruzioni.

---

## 🤖 EN — For AI Agents: How to Setup Antigravity

### User Trigger Phrases

When the user says any of these:
- `"read Antigravity"` / `"leggi Antigravity"`
- `"setup Antigravity"` / `"configure Antigravity"`
- `"inizializza Antigravity"` / `"usa Antigravity"`
- `"configura Antigravity"` / `"installa Antigravity"`
- `"setup agentic framework"` / `"setup Antigravity"`
...
1. **Read all files in `Antigravity/`** — understand the available directives, templates, and scripts.
...
2. Run setup script:
   ```bash
   python antigravity/scripts/setup.py --auto --project-name "[detected_name]" --from-project-file PROJECT.md
   ```

**If NOT found:**
1. Ask user: *"I detected the `Antigravity/` folder but no `PROJECT.md`. Would you like me to create one, or can you point me to a project description?"*
2. Offer to create `PROJECT.md` from template: `Antigravity/templates/PROJECT.md.template`
...
- `"leggi Antigravity"` / `"read Antigravity"`
- `"configura Antigravity"` / `"setup Antigravity"`
- `"inizializza Antigravity"` / `"usa Antigravity"`
...
1. **Leggi tutti i file in `Antigravity/`** — comprendi le direttive, i template e gli script disponibili.
...
2. Esegui lo script di setup:
   ```bash
   python antigravity/scripts/setup.py --auto --project-name "[nome_rilevato]" --from-project-file PROJECT.md
   ```

**Se NON trovato:**
1. Chiedi all'utente: *"Ho rilevato la cartella `Antigravity/` ma nessun `PROJECT.md`. Vuoi che ne crei uno, o puoi indicarmi una descrizione del progetto?"*
2. Offri di creare `PROJECT.md` dal template: `Antigravity/templates/PROJECT.md.template`
...
|---------------------------|-----------------|
| `"read Antigravity"` / `"leggi Antigravity"` | `python antigravity/scripts/read_Antigravity.py` |
| `"setup Antigravity"` / `"configura Antigravity"` | `python antigravity/scripts/setup.py` |
| `"start task TASK-XXX 'desc'"` | `python antigravity/scripts/task.py start TASK-XXX "desc"` |
| `"avvia task TASK-XXX 'desc'"` | `python antigravity/scripts/task.py start TASK-XXX "desc"` |
| `"start TDD task TASK-XXX 'desc'"` | `python antigravity/scripts/task-tdd.py start TASK-XXX "desc"` |
| `"avvia task TDD TASK-XXX 'desc'"` | `python antigravity/scripts/task-tdd.py start TASK-XXX "desc"` |
| `"list tasks"` / `"mostra i task"` | `python antigravity/scripts/task.py list` |
| `"run tests"` / `"esegui i test"` | `python antigravity/scripts/task-tdd.py test` |
| `"complete task TASK-XXX"` | `python antigravity/scripts/task.py complete TASK-XXX "done"` |
| `"completa task TASK-XXX"` | `python antigravity/scripts/task.py complete TASK-XXX "fatto"` |
| `"sync configs"` / `"sincronizza configurazioni"` | `bash antigravity/scripts/sync-configs.sh` |
...
5. **Commit selectively** — never use `git add -A`. Use `Antigravity/execution/git_commit.py` or specify files explicitly.
...
5. **Commit selettivo** — non usare mai `git add -A`. Usa `Antigravity/execution/git_commit.py` o specifica i file esplicitamente.
